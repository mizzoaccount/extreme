...
import { ArrowRight, Instagram, Twitter, ShoppingBag } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        {/* Large borderless hero image *
        <motion.div 
        className="relative w-full h-[700px] md:h-[800px] mt-8 md:mt-0 flex items-center justify-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.4 }}
      >
        <motion.div
          className="relative w-full h-full max-w-xl lg:max-w-2xl flex items-center justify-center"
