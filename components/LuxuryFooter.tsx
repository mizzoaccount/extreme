        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              <motion.li whileHover={{ x: 5 }}>
                <a href="mailto:service@extremecollections.com" className="flex items-center hover:text-[#f4b500] transition-colors">
                  <Mail size={16} className="mr-3 text-[#f4b500]" /> service@extremecollections.com
                </a>
              </motion.li>
              <motion.li whileHover={{ x: 5 }}>
