    ...
    >
      ...
      <div className="pt-6 flex justify-between">
        ...
        <button
          ...
          className="px-6 py-3 bg-[#82cee4] hover:bg-[#62aee4] text-black font-bold rounded-full transition-colors flex items-center justify-center gap-2 disabled:opacity-70"
        >
