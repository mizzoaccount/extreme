                ...
                <div className="bg-gray-100 p-6 rounded-xl border border-gray-200">
                  ...
                  <Link href="/checkout" passHref legacyBehavior>
                    <motion.a
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="block w-full bg-[#f4b500] hover:bg-[#d4a017] text-black font-bold py-3 px-6 rounded-full text-center transition-colors flex items-center justify-center gap-2"
                    >
                  ...
                  <p className="text-center text-sm text-gray-500 mt-4">
                    or <Link href="/collections" className="text-[#f4b500] hover:underline">Continue Shopping</Link>
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <Link href="/collections" passHref legacyBehavior>
                <motion.a
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="inline-block px-6 py-3 bg-[#f4b500] hover:bg-[#d4a017] text-black font-bold rounded-full transition-colors"
                >
                  Browse Collections
                </motion.a>
              </Link>
